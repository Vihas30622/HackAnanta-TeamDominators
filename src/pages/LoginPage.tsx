  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        ...
        {!isConfigured && (
          <motion.div
            ...
            className="mt-6 p-3 rounded-xl bg-warning/10 border border-warning/30 max-w-xs"
          >
            <div className="flex items-start gap-2">
              <AlertCircle className="w-4 h-4 text-warning flex-shrink-0 mt-0.5" />
              <p className="text-xs text-muted-foreground">
                <span className="font-medium text-warning">Demo Mode:</span> Firebase not configured. App will use mock authentication.
              </p>
            </div>
          </motion.div>
        )}
      ...
      <motion.div
        ...
        className="px-6 pb-12 safe-area-bottom"
      >
        <Button
          onClick={login}
          disabled={isLoading}
